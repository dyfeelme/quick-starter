package com.zs.framework.nutz.task;
...
public class CleanNonActiveUserJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        Sql sql = Sqls.create("delete from $user_table where id > 10 and not exists (select 1 from $user_profile_table where $user_table.id = user_id ) and create_time < @deadtime");
